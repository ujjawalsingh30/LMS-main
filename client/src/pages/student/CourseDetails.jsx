  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        {/* this color property not work 3:29:30 in the course details page */}
        {/* <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70 '></div>  */}
        <div className='absolute top-0 left-0 w-full md:pt-31 pt-20 px-7 md:px-0  bg-gradient-to-b from-cyan-100/70'></div>



        {/* left column */}
        <div className='max-w-xl z-10 text-gray-500'>
          <h1 className='text-[28px] md:text-5xl lg:text-4xl leading-tight font-semibold text-gray-800'>{courseData.courseTitle}</h1>
        ...
        {/* right column */}
        <div className='max-w-course-card z-10 shadow-custom-card box-shadow max-width rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            ...
            <button onClick={enrollCourse} className='md:mt-6 mt-4 w-full py-3 rounded-lg bg-blue-600 text-white font-medium cursor-pointer'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enrolled Now'}</button>
